// desafio dia 6 Remoção de Arrays
...
while (adicionarMais != "não"){
    ...
    while (adicionarMais != "sim" && adicionarMais != "não" && adicionarMais != "remover") {//enquanto o texto lido for diferente de "sim" e de "não", exibir que não foi reconhecido e perguntar novamente
